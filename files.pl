our @c_files = qw(
AM        ODPLAY    OGAMESET  ORAIN2    OSPRITE2  OUNITIF
...
OAI_BUIL  OERRCTRL  OGAMSCE2  OREGION   OSPY2     OUNITS
OAI_CAP2  OERROR    OGAMSCEN  OREGIONS  OSPYA     OU_CARA
OAI_CAPT  OEXPMASK  OGAMSING  OREMOTE   OSTR      OU_CARA2
OAI_DEFE  OFILE     OGENHILL  OREMOTE2  OSYS      OU_CARAS
OAI_DIPL  OFILETXT  OGENMAP   OREMOTEM  OSYS2     OU_CARAT
OAI_ECO   OFIRM     OGETA     OREMOTEQ  OSYS3     OU_CART
...
OBOX      OF_INN2   ITNL_MOUSE    OSITE     OUNITA    OWALLRES
...
OCRC_STO  OGAME     OPLASMA   OSPREOFF  OUNITD    OFLAME
ODATE     OGAMEMP   OPOWER    OSPRESMO  OUNITDRW  OGF_V1
ODB       OGAMENCY  ORACERES  OSPREUSE  OUNITHB   ODIR      
OGAMEND   ORAIN1    OSPRITE   OUNITI  OTALKSPA  OTALKFRE  
OTALKGER  ONEWSFRE  ONEWSSPA  ONEWSGER
);
